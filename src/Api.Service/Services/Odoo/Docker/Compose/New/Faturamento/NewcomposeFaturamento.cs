...
namespace Api.Service.Services.Odoo.Docker.Compose.New.Faturamento
{
    public class NewcomposeFaturamento
    {
        ...
        {
            composePath = Path.GetFullPath(basePath).Substring(0, 5) + @"/" + customerEmail + @"/" + "Faturamento";
