...
namespace Api.Service.Services.Odoo.Docker.Compose.New.CRM
{
    public class NewcomposeCRM
    {
        ...
        public NewcomposeCRM(string CustomerEmail, string OdooPort, string DockerImage)
        {
        ...
        {
            composePath = Path.GetFullPath(basePath).Substring(0, 5) + @"/" + customerEmail + @"/" + customerEmail + "_CRM";
