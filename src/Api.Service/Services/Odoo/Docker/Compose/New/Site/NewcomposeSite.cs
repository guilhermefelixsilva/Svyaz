...
namespace Api.Service.Services.Odoo.Docker.Compose.New.Site
{
    public class NewcomposeSite
    {
        ...
        public NewcomposeSite(string CustomerEmail, string OdooPort, string DockerImage)
        {
        ...
        {
            composePath = Path.GetFullPath(basePath).Substring(0, 5) + @"/" + customerEmail + @"/" + customerEmail + "_Site";
