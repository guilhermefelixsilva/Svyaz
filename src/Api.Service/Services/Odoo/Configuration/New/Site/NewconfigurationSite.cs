...
namespace Api.Service.Services.Odoo.Configuration.New.Site
{
    public class NewconfigurationSite
    {
        ...
        public NewconfigurationSite(string CustomerEmail, string CustomerTag)
        {
        ...
        private void Newodooconf() //Odoo.conf
        {
            ...
            configPath = Path.GetFullPath(basePath).Substring(0, 5) + @"/" + customerEmail + @"/SITE/" + customerEmail + "_" + customerTag;
            ...
            writer.WriteLine("logfile = " + Path.GetFullPath(basePath).Substring(0, 5) + @"/" + customerEmail + @"/Logs" + @"/" + "Site" + @"/odoo-server" + ".log");
        ...
        {
            logPath = Path.GetFullPath(basePath).Substring(0, 5) + @"/" + customerEmail + @"/Logs" + @"/" + "Site";
